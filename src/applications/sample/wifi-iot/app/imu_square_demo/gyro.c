...
void init_ctrl_algo(void)
{
    ...
    car_drive.LeftForward = 25; // 13 左轮前进速度
    car_drive.RightForward = 25; // 10 右轮前进速度
    car_drive.TurnRight = 25; // 30 右转弯左轮速度
    car_drive.yaw1 = YAW;
    car_drive.yaw2 = 180.0; // 航向角181.0
    car_drive.yaw3 = 270.0; // 航向角270.0
    car_drive.yaw4 = 360.0; // 航向角360.0
    car_drive.time = 2000; // 行驶时间3000ms
}
